...
vacunas1_semanal = vac_1dosis %>% filter(Edad>="3", Edad<="39", Fecha>="2021-01-30") %>% 
...
vacunas2_semanal = vac_2dosis %>% filter(Edad>="3", Edad<="39", Fecha>="2021-01-30") %>% 
...
me39.sem = me39.sem %>% mutate(p_Casos = (Casos/poblacion.18_39)*100000)
me39.sem = me39.sem %>% mutate(p_Camas = (Camas/poblacion.18_39)*100000)
me39.sem = me39.sem %>% mutate(p_Vac.totales = (Vac.totales/poblacion.18_39)*100000)
me39.sem = me39.sem %>% mutate(p_Vac.1d = (Vac.1d/poblacion.18_39)*100000)
me39.sem = me39.sem %>% mutate(p_Vac.2d = (Vac.2d/poblacion.18_39)*100000)
...
ggplot(data = me39.sem, aes(x = p_Camas)) +
...
#Models
mod.me39.1 = gamlss(formula = p_Camas~p_Casos,
                    family=GA, trace=F,data = me39.sem)
mod.me39.2 = gamlss(formula = p_Camas~p_Vac.totales,
                    family=GA, trace=F,data = me39.sem)
mod.me39.3 = gamlss(formula = p_Camas~p_Casos+p_Vac.totales,
                    family=GA, trace=F,data = me39.sem)
mod.me39.4 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d,
                    family=GA, trace=F,data = me39.sem)
mod.me39.5 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                    family=GA, trace=F,data = me39.sem)
mod.me39.6 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d,
                    family=GA, trace=F,data = me39.sem)
mod.me39.7 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                    family=GA, trace=F,data = me39.sem)

#Evaluations
GAIC(mod.me39.1, mod.me39.2, mod.me39.3, mod.me39.4, mod.me39.5, mod.me39.6, mod.me39.7)
VC.test(mod.me39.5, mod.me39.7)
r1_me39 = Rsq(mod.me39.7, type = c("Cox Snell","Cragg Uhler","both")); r1_me39
r2_me39 = Rsq(mod.me39.6, type = c("Cox Snell","Cragg Uhler","both")); r2_me39
summary(mod.me39.7)
plot(mod.me39.7)
wp(mod.me39.7, ylim.all = 0.8)
drop1(mod.me39.7, parallel = "multicore", ncpus = 4)
VC.test(mod.me39.7, mod.me39.6) #Hay diferencias
term.plot(mod.me39.7, pages = 1, ask = FALSE, rug = TRUE)
me39.sem = me39.sem %>% mutate(pred_me39 = fitted(mod.me39.7))
me39.sem = me39.sem %>% mutate(pred_me39.malo = fitted(mod.me39.6))


#Graphics
a1 = ggplot(me39.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(as.Date(Fecha), pred_me39), se=TRUE, method = "gam",color="#41b6c4", size=0.1)+
  labs(x="Date",
       y="Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = "A")+
  annotate(geom="text",x=as.Date("2021-04-02"),
           y=8,label=paste("R\u00b2 = ", round(r1_me39,4)),fontface="bold", size=1.7)+
...
a2 = ggplot(me39.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(as.Date(Fecha), pred_me39.malo), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x="Date",
       y="Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = " ")+
  annotate(geom="text",x=as.Date("2021-04-02"),
           y=8,label=paste("R\u00b2 = ",round(r2_me39,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 10))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
de40_49.sem = de40_49.sem %>% mutate(p_Casos = (Casos/poblacion.de40_49)*100000)
de40_49.sem = de40_49.sem %>% mutate(p_Camas = (Camas/poblacion.de40_49)*100000)
de40_49.sem = de40_49.sem %>% mutate(p_Vac.totales = (Vac.totales/poblacion.de40_49)*100000)
de40_49.sem = de40_49.sem %>% mutate(p_Vac.1d = (Vac.1d/poblacion.de40_49)*100000)
de40_49.sem = de40_49.sem %>% mutate(p_Vac.2d = (Vac.2d/poblacion.de40_49)*100000)
...
ggplot(data = de40_49.sem, aes(x = p_Camas)) +
  geom_density(alpha = 0.5, fill = "gray50") +
  geom_rug(alpha = 0.2) +
  labs(title = "Distribución UCI entre 18 y 39 normalizados") +
  theme_bw()
...
#Models
mod.40_49.1 = gamlss(formula = p_Camas~p_Casos,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.2 = gamlss(formula = p_Camas~p_Vac.totales,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.3 = gamlss(formula = p_Camas~p_Casos+p_Vac.totales,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.4 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.5 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.6 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de40_49.sem)
mod.40_49.7 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de40_49.sem)
...
#Graphics
b1 = ggplot(de40_49.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(as.Date(Fecha), pred.40_49), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = "B")+
  annotate(geom="text",x=as.Date("2021-07-15"),
           y=35,label=paste("R\u00b2 = ", round(r1_40_49,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
...
b2 = ggplot(de40_49.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(as.Date(Fecha), pred.40_49.def), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = " ")+
  annotate(geom="text",x=as.Date("2021-07-15"),
           y=35,label=paste("R\u00b2 = ", round(r2_40_49,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 40))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
de50_59.sem = de50_59.sem %>% mutate(p_Casos = (Casos/poblacion.50_59)*100000)
de50_59.sem = de50_59.sem %>% mutate(p_Camas = (Camas/poblacion.50_59)*100000)
de50_59.sem = de50_59.sem %>% mutate(p_Vac.totales = (Vac.totales/poblacion.50_59)*100000)
de50_59.sem = de50_59.sem %>% mutate(p_Vac.1d = (Vac.1d/poblacion.50_59)*100000)
de50_59.sem = de50_59.sem %>% mutate(p_Vac.2d = (Vac.2d/poblacion.50_59)*100000)
...
#Models
mod.50_59.1 = gamlss(formula = p_Camas~p_Casos,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.2 = gamlss(formula = p_Camas~p_Vac.totales,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.3 = gamlss(formula = p_Camas~p_Casos+p_Vac.totales,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.4 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.5 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.6 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de50_59.sem)
mod.50_59.7 = gamlss(formula = p_Camas~Casos+p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de50_59.sem)
...
VC.test(mod.50_59.7, mod.50_59.6) #Hay diferencias entre modelos
...
#Graphics
c1 = ggplot(de50_59.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(as.Date(Fecha), pred.50_59), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = "C")+
  annotate(geom="text",x=as.Date("2021-07-15"),
           y=45,label=paste("R\u00b2 = ", round(r1_50_59,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
...
c2 = ggplot(de50_59.sem, aes(as.Date(Fecha), p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  #geom_smooth(mapping = aes(as.Date(Fecha), pred.50_59.def), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  stat_smooth(mapping = aes(as.Date(Fecha), pred.50_59.def), se=TRUE, method = "gam", color="#41b6c4", size=0.1, fullrange = TRUE)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = " ")+
  annotate(geom="text",x=as.Date("2021-07-15"),
           y=45,label=paste("R\u00b2 = ", round(r2_50_59,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 50))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
de60_69.sem = de60_69.sem %>% mutate(p_Casos = (Casos/poblacion.60_69)*100000)
de60_69.sem = de60_69.sem %>% mutate(p_Camas = (Camas/poblacion.60_69)*100000)
de60_69.sem = de60_69.sem %>% mutate(p_Vac.totales = (Vac.totales/poblacion.60_69)*100000)
de60_69.sem = de60_69.sem %>% mutate(p_Vac.1d = (Vac.1d/poblacion.60_69)*100000)
de60_69.sem = de60_69.sem %>% mutate(p_Vac.2d = (Vac.2d/poblacion.60_69)*100000)
...
#Models
mod.60_69.1 = gamlss(formula = p_Camas~p_Casos,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.2 = gamlss(formula = p_Camas~p_Vac.totales,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.3 = gamlss(formula = p_Camas~p_Casos+p_Vac.totales,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.4 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.5 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.6 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d,
                     family=GA, trace=F,data = de60_69.sem)
mod.60_69.7 = gamlss(formula = p_Camas~Casos+p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                     family=GA, trace=F,data = de60_69.sem)

#Evaluation
GAIC(mod.60_69.1, mod.60_69.2, mod.60_69.3, mod.60_69.4, mod.60_69.5, mod.60_69.6, mod.60_69.7)
VC.test(mod.60_69.1, mod.60_69.3)
r1_60_69 = Rsq(mod.60_69.1, type = c("Cox Snell","Cragg Uhler","both")); r1_60_69
r2_60_69 = Rsq(mod.60_69.7, type = c("Cox Snell","Cragg Uhler","both")); r2_60_69
summary(mod.60_69.1)
plot(mod.60_69.1)
...
#Graphics
d1 = ggplot(de60_69.sem, aes(Fecha, p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(Fecha, pred.60_69), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = "D")+
  annotate(geom="text",x=as.Date("2021-08-02"),
           y=55,label=paste("R\u00b2 = ", round(r1_60_69,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
...
d2 = ggplot(de60_69.sem, aes(Fecha, p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(Fecha, pred.60_69.def), se=TRUE, method = "gam", color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = " ")+
  annotate(geom="text",x=as.Date("2021-08-02"),
           y=55,label=paste("R\u00b2 = ", round(r2_60_69, 4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 60))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
ma70.sem = ma70.sem %>% mutate(p_Casos = (Casos/poblacion.ma70)*100000)
ma70.sem = ma70.sem %>% mutate(p_Camas = (Camas/poblacion.ma70)*100000)
ma70.sem = ma70.sem %>% mutate(p_Vac.totales = (Vac.totales/poblacion.ma70)*100000)
ma70.sem = ma70.sem %>% mutate(p_Vac.1d = (Vac.1d/poblacion.ma70)*100000)
ma70.sem = ma70.sem %>% mutate(p_Vac.2d = (Vac.2d/poblacion.ma70)*100000)
...
#Models
mod.ma70.1 = gamlss(formula = p_Camas~p_Casos,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.2 = gamlss(formula = p_Camas~p_Vac.totales,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.3 = gamlss(formula = p_Camas~p_Casos+p_Vac.totales,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.4 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.5 = gamlss(formula = p_Camas~p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.6 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d,
                    family=GA, trace=F,data = ma70.sem)
mod.ma70.7 = gamlss(formula = p_Camas~p_Casos+p_Vac.1d+p_Vac.2d+p_Vac.1d:p_Vac.2d,
                    family=GA, trace=F,data = ma70.sem)

#Evaluations
GAIC(mod.ma70.1, mod.ma70.2, mod.ma70.3, mod.ma70.4, mod.ma70.5, mod.ma70.6, mod.ma70.7)
VC.test(mod.ma70.6, mod.ma70.3)
...
VC.test(mod.ma70.3, mod.ma70.7) #Hay diferencias entre modelos
...
#Graphics
e1 = ggplot(ma70.sem1, aes(Fecha, p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(Fecha, pred_ma70), se=TRUE, method = "gam",color="#41b6c4", size=0.1, fill ="gray")+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = "E")+
  annotate(geom="text",x=as.Date("2021-04-02"),
           y=35,label=paste("R\u00b2 = ", round(r1_ma70,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 40))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
e2 = ggplot(ma70.sem1, aes(Fecha, p_Camas))+
  geom_point(color="#225ea8", size=0.1)+
  geom_smooth(mapping = aes(Fecha, pred_ma70.def), se=TRUE, method = "gam",color="#41b6c4", size=0.1)+
  labs(x = "Date",
       y = "Weekly occupied ICU beds \nper 100,000 inhabitants",
       tag = " ")+
  annotate(geom="text",x=as.Date("2021-04-02"),
           y=35,label=paste("R\u00b2 = ", round(r2_ma70,4)),fontface="bold", size=1.7)+
  scale_x_date(date_breaks = "1 month", date_labels =  "%b")+
  scale_y_continuous(limits = c(0, 40))+
  theme_classic()+
  theme(axis.line = element_line(size = 0.4),
...
uci_edad = grid.arrange(arrangeGrob(a1,f,a2,f,b1,f,b2, ncol = 7, widths = c(4,0.3,4,1,4,0.3,4)),
...
uci_edad_1 = grid.arrange(arrangeGrob(a1,f,a2,f,b1,f,b2, ncol = 7, widths = c(43, 1, 43, 6, 43, 1, 43)),
                          arrangeGrob(f, ncol = 1, widths = c(180)),
                          arrangeGrob(c1,f,c2,f,d1,f,d2, ncol=7,widths = c(43, 1, 43, 6, 43, 1, 43)),
                          arrangeGrob(f, ncol = 1, widths = c(180)),
